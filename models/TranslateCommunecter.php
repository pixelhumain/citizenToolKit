...
*/
	...
	public static $dataBinding_city = array(
	    ...
	    "level1" 		=> array("valueOf" => "level1"),
	    "level1Name" 		=> array("valueOf" => "level1Name"),
	    "level2" 		=> array("valueOf" => "level2"),
	    "level2Name" 		=> array("valueOf" => "level2Name"),
	    "level3" 		=> array("valueOf" => "level3"),
	    "level3Name" 		=> array("valueOf" => "level3Name"),
	    "level4" 		=> array("valueOf" => "level4"),
	    "level4Name" 		=> array("valueOf" => "level4Name"),
