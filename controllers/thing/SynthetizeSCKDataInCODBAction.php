...
* supression des plus vieux enregistrement (mois par mois) jusqu'à le mois de la date fourni $end
* si $end n'est pas fourni on garde les 2 ou 3 derniers mois (on changer limit pour gardé plus de mois)
*
*/
...
class SynthetizeSCKDataInCODBAction extends CAction {
	...
	public function run($boardId=null,$end=null,$rollupMin=60,$boardIds=null){
		...
		if ($_SERVER['REQUEST_METHOD'] == 'GET') {
			...
			$interval = new DateInterval('P1M'); //P1D si en jours | P1M si mois
			$intervalLimit = new DateInterval('P2M'); //P60D si en jours | P2M si mois
